define("theme_becode/courseindexdrawercontrols", [
  "exports",
  "core/reactive",
  "core_courseformat/courseeditor",
], function (_exports, _reactive, _courseeditor) {
   ...
   */
  class Component extends _reactive.BaseComponent {
    create() {
    ...
    static init(target, selectors) {
      return new Component({
        ...
        reactive: (0, _courseeditor.getCurrentCourseEditor)(),
        selectors: selectors,
      });
    }
    stateReady() {
    ...
    _collapseAllSections() {
      this._toggleAllSections(!0);
    }
    _expandAllSections() {
      this._toggleAllSections(!1);
    }
